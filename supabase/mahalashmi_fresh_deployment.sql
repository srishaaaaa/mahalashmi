-- ============================================================================
-- Mahalashmi Stores - Fresh Deployment Schema (Clean Build)
--
-- PRODUCTION DEPLOYMENT FILE: Complete database schema for fresh provisioning
-- This file contains ONLY Mahalashmi Stores configuration - no legacy data
--
-- Deploy this to start fresh with:
-- - Clean tables with proper structure
-- - Correct functions (fixed duplicates)
-- - Proper branding and settings
-- - All required policies and storage
--
-- ============================================================================
...
-- ============================================================================
-- SEED DATA (Fresh Mahalashmi Setup Only)
-- ============================================================================
...
-- ============================================================================
-- NOTIFICATION (Reload Supabase Schema)
-- ============================================================================
...
-- For: Mahalashmi Stores (Fresh Deployment)
-- Status: Production Ready
-- All legacy YG ENTERPRISES data removed
-- ============================================================================
