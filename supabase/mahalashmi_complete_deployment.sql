...
-- MIGRATION: 20260926_0041 - Fix duplicate get_next_invoice_no function
-- Drops all duplicate versions and recreates the correct one
-- Final invoice-number generator: plain 8-digit zero-padded sequence value
...
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Turmeric Powder', 'மஞ்சள் பொடி', 'மஞ்சள் பொடி', 'Spices', 250.00, 180.00, 280.00, 5.0, 'piece', 50.00, 50, 5, TRUE),
  ('Black Pepper', 'கருப்பு மிளகு', 'கருப்பு மிளகு', 'Spices', 320.00, 250.00, 350.00, 5.0, 'piece', 30.00, 30, 5, TRUE),
  ('Cumin Seeds', 'சீரகம்', 'சீரகம்', 'Spices', 180.00, 140.00, 200.00, 5.0, 'piece', 40.00, 40, 5, TRUE),
  ('Coriander Powder', 'கொத்தமல்லி பொடி', 'கொத்தமல்லி பொடி', 'Spices', 220.00, 160.00, 250.00, 5.0, 'piece', 45.00, 45, 5, TRUE),
  ('Chili Powder', 'மிளகாய் பொடி', 'மிளகாய் பொடி', 'Spices', 280.00, 200.00, 320.00, 5.0, 'piece', 35.00, 35, 5, TRUE);

-- Grains Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Basmati Rice', 'பாஸ்மதி அரிசி', 'பாஸ்மதி அரிசி', 'Grains', 500.00, 400.00, 550.00, 5.0, 'piece', 100.00, 100, 10, TRUE),
  ('White Rice', 'வெள்ளை அரிசி', 'வெள்ளை அரிசி', 'Grains', 350.00, 280.00, 400.00, 5.0, 'piece', 80.00, 80, 10, TRUE),
  ('Wheat Flour', 'கோதுமை மாவு', 'கோதுமை மாவு', 'Grains', 150.00, 120.00, 170.00, 5.0, 'piece', 120.00, 120, 15, TRUE),
  ('Chickpea', 'கொண்டைக்கடலை', 'கொண்டைக்கடலை', 'Grains', 220.00, 170.00, 250.00, 5.0, 'piece', 60.00, 60, 8, TRUE);

-- Beverages Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Green Tea', 'பச்சை தேநீர்', 'பச்சை தேநீர்', 'Beverages', 150.00, 100.00, 180.00, 5.0, 'piece', 75.00, 75, 10, TRUE),
  ('Black Tea', 'கறுப்பு தேநீர்', 'கறுப்பு தேநீர்', 'Beverages', 180.00, 130.00, 210.00, 5.0, 'piece', 85.00, 85, 10, TRUE),
  ('Coffee Powder', 'காபி பொடி', 'காபி பொடி', 'Beverages', 320.00, 240.00, 380.00, 5.0, 'piece', 40.00, 40, 5, TRUE),
  ('Milk Powder', 'பால் பொடி', 'பால் பொடி', 'Beverages', 450.00, 350.00, 520.00, 5.0, 'piece', 50.00, 50, 8, TRUE);

-- Oils & Condiments Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Coconut Oil', 'தேங்காய் எண்ணெய்', 'தேங்காய் எண்ணெய்', 'Oils & Condiments', 380.00, 300.00, 420.00, 5.0, 'piece', 60.00, 60, 8, TRUE),
  ('Sesame Oil', 'எள் எண்ணெய்', 'எள் எண்ணெய்', 'Oils & Condiments', 420.00, 330.00, 480.00, 5.0, 'piece', 45.00, 45, 6, TRUE),
  ('Ghee', 'நெய்', 'நெய்', 'Oils & Condiments', 550.00, 450.00, 600.00, 5.0, 'piece', 35.00, 35, 5, TRUE),
  ('Honey', 'தேன்', 'தேன்', 'Oils & Condiments', 280.00, 200.00, 320.00, 5.0, 'piece', 25.00, 25, 3, TRUE);

-- Snacks & Dry Fruits Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Almonds', 'பாதாம்', 'பாதாம்', 'Snacks & Dry Fruits', 680.00, 550.00, 750.00, 5.0, 'piece', 30.00, 30, 5, TRUE),
  ('Cashews', 'முந்திரிப்பருப்பு', 'முந்திரிப்பருப்பு', 'Snacks & Dry Fruits', 720.00, 600.00, 800.00, 5.0, 'piece', 25.00, 25, 4, TRUE),
  ('Raisins', 'உலர்ந்த திராட்சை', 'உலர்ந்த திராட்சை', 'Snacks & Dry Fruits', 480.00, 380.00, 530.00, 5.0, 'piece', 35.00, 35, 5, TRUE),
  ('Peanuts', 'வேர்க்கடலை', 'வேர்க்கடலை', 'Snacks & Dry Fruits', 220.00, 150.00, 250.00, 5.0, 'piece', 70.00, 70, 10, TRUE);

-- Dairy & Eggs Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Yogurt', 'தயிர்', 'தயிர்', 'Dairy & Eggs', 80.00, 50.00, 100.00, 5.0, 'piece', 40.00, 40, 8, TRUE),
  ('Paneer', 'பனீர்', 'பனீர்', 'Dairy & Eggs', 320.00, 250.00, 380.00, 5.0, 'piece', 20.00, 20, 3, TRUE),
  ('Cheese', 'சீஸ்', 'சீஸ்', 'Dairy & Eggs', 280.00, 200.00, 320.00, 5.0, 'piece', 15.00, 15, 3, TRUE),
  ('Butter', 'வெண்ணெய்', 'வெண்ணெய்', 'Dairy & Eggs', 350.00, 280.00, 400.00, 5.0, 'piece', 25.00, 25, 5, TRUE);

-- Vegetables Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Tomato', 'தக்காளி', 'தக்காளி', 'Vegetables', 50.00, 30.00, 60.00, 5.0, 'piece', 100.00, 100, 20, TRUE),
  ('Onion', 'வெங்காயம்', 'வெங்காயம்', 'Vegetables', 40.00, 25.00, 50.00, 5.0, 'piece', 120.00, 120, 25, TRUE),
  ('Potato', 'உருளைக்கிழங்கு', 'உருளைக்கிழங்கு', 'Vegetables', 35.00, 20.00, 45.00, 5.0, 'piece', 150.00, 150, 30, TRUE),
  ('Carrot', 'கேரட்', 'கேரட்', 'Vegetables', 60.00, 40.00, 75.00, 5.0, 'piece', 80.00, 80, 15, TRUE);

-- Fruits Category
INSERT INTO public.products (name, name_ta, tamil_name, category, price, purchase_price, mrp, gst_percent, unit, stock_quantity, stock, low_stock_alert, is_active) VALUES
  ('Banana', 'வாழைப்பழம்', 'வாழைப்பழம்', 'Fruits', 45.00, 25.00, 55.00, 5.0, 'piece', 90.00, 90, 15, TRUE),
  ('Orange', 'ஆரஞ்சு', 'ஆரஞ்சு', 'Fruits', 80.00, 50.00, 100.00, 5.0, 'piece', 50.00, 50, 10, TRUE),
  ('Apple', 'ஆப்பிள்', 'ஆப்பிள்', 'Fruits', 120.00, 80.00, 150.00, 5.0, 'piece', 40.00, 40, 8, TRUE),
  ('Mango', 'மாம்பழம்', 'மாம்பழம்', 'Fruits', 90.00, 60.00, 110.00, 5.0, 'piece', 60.00, 60, 12, TRUE);
