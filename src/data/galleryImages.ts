...
export const galleryImages: GalleryImage[] = [
  {
    id: 1,
    title: 'Our Store',
    description: 'Mahalashmi Stores in Masinaickanpatty, Salem',
  ...
  },
  {
    ...
    description: 'Curated herbal products, groceries, and pooja essentials',
  ...
  },
  {
    ...
    description: 'Thoughtful, friendly service for every customer',
