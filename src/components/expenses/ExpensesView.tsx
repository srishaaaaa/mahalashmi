  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-4">
        ...
        {/* View Switch Pills */}
        <div className="flex items-center gap-2 bg-[#FBFAF6] p-1.5 rounded-2xl border border-[#E8D9A0]">
          <button
            type="button"
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between gap-1 mb-2">
                  ...
                  <div className="w-6 h-6 rounded-lg bg-[#FBFAF6] border border-[#E8D9A0]/60 flex items-center justify-center text-[#D4AF37] group-hover:scale-105 transition-transform">
                    ...
                    filteredExpenses.map((exp) => (
                      <tr key={exp.id} className="hover:bg-gray-50/70 transition-colors">
                        ...
                        <td className="px-5 py-3.5">
                          <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-bold bg-[#FBFAF6] text-[#0A0A0A] border border-[#E8D9A0]">
                            {exp.category_name}
                          </span>
                        </td>
