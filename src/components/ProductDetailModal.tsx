              ...
              {product.hasVariants ? (
                ...
                <div className="mx-auto flex max-w-xl items-center gap-3">
                  <div className="min-w-0">
                    ...
                    <p className="break-words text-[10px] font-bold text-[#95a28f]">{mobileQty > 0 ? mobileSummary : 'Premium quick view'}</p>
                  </div>
                ...
                <section className="mt-5 grid gap-2.5">
                  ...
                  <details className={accordionClass}>
                    ...
                    <div className="mt-3 space-y-2 text-sm leading-relaxed text-[#5f6d59]">
                      <p className="whitespace-pre-line">{product.benefits || `Sourced with care by ${BRAND_SHORT}.`}</p>
                ...
                <div className="min-w-0">
                  ...
                  {product.hasVariants && selectedVariant ? (
                    <>
                      ...
                      <p className="break-words text-[10px] font-bold text-[#95a28f]">
                    ...
                    <>
                      ...
                      <p className="break-words text-[10px] font-bold text-[#95a28f]">Select a variant</p>
                    </>
                  ) : (
                    <>
