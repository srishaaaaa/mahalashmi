          ...
          filtered.map(order => (
            <div key={order.id} className="px-4 py-3.5">
              ...
              <div className="mt-2.5 flex flex-wrap items-center gap-1.5">
                ...
                <button type="button" onClick={() => void openDetails(order)} className="w-9 h-9 rounded-lg bg-[#F4F2F6] hover:bg-violet-100 text-violet-700 flex items-center justify-center transition-colors cursor-pointer shrink-0" title="View Details">
                  <Eye size={15}/>
                </button>
                ...
                <button type="button" onClick={() => downloadFile(order.status === 'completed' ? invoiceFile(order) : advanceReceiptPdf(order))} className="w-9 h-9 rounded-lg bg-violet-50 hover:bg-violet-100 text-violet-700 flex items-center justify-center transition-colors cursor-pointer shrink-0" title="Download">
                  <Download size={15}/>
                </button>
