      ...
      <div className="mx-auto max-w-7xl px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-grow">
          ...
          <div className="mt-12 p-6 sm:p-8 bg-green-50 border border-green-100 rounded-3xl flex flex-col sm:flex-row items-center gap-6">
             ...
             <div>
                <h4 className="font-black text-lg text-[#0A0A0A] leading-tight">{BRAND_SHORT} Assured Quality</h4>
                <p className="text-sm text-gray-700 mt-1">Every product in our store is checked for freshness and verified for quality before it reaches your shelf.</p>
             </div>
          </div>
        </div>
      </div>
