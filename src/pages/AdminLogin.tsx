      ...
      <div className="relative grid w-full max-w-4xl max-h-[92vh] overflow-hidden rounded-3xl border border-gray-200/90 bg-[#141414] shadow-[0_25px_60px_-12px_rgba(0,0,0,0.25),0_12px_28px_-6px_rgba(0,0,0,0.15)] lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="p-5 sm:p-7 lg:p-8 bg-white text-[#111111] overflow-y-auto hide-scrollbar flex flex-col justify-center">
          ...
          <div className="mb-4 sm:mb-5 flex flex-col items-center text-center lg:items-start lg:text-left">
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-[#8A6D1E]">{BRAND_SUBTITLE}</p>
            ...
            <p className="mt-2.5 inline-flex items-center gap-1.5 rounded-full border border-[#D4AF37] bg-[#FBFAF6] px-3 py-1 text-[10px] font-black uppercase tracking-wider text-[#0A0A0A]">
              <ShieldCheck size={12} className="text-[#8A6D1E]" />
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-3.5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border-2 border-[#E8D9A0] bg-[#FBFAF6] px-3.5 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#0A0A0A] focus:bg-white text-[#111111]"
                value={portalId}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border-2 border-[#E8D9A0] bg-[#FBFAF6] px-3.5 py-2.5 sm:py-3 pr-11 text-xs sm:text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#0A0A0A] focus:bg-white text-[#111111]"
                  value={password}
