                                  ...
                                  return (
                                    <div key={i} className="py-2 flex items-start justify-between gap-3">
                                      <div className="min-w-0">
                                        <p className="font-medium text-textMain text-[13px] break-words">{pName}</p>
                                        <p className="text-[11px] text-textMuted mt-0.5">{formatQuantityDisplay(item.quantity, item.unit, item.unit_type)}</p>
                                      </div>
                                      <p className="shrink-0 font-bold text-textMain text-[13px]">{formatCurrency(item.line_total)}</p>
                                    </div>
                                  )
                                })}
                              </div>
